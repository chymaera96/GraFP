...
def main():
    ...
    test_idx = {}
    test_idx_list = list(set(all_file_list) - set(train_idx.values()))
    test_idx_list = list(set(test_idx_list) - set(valid_idx.values()))
    print(f'Number of files in test index: {len(test_idx_list)}')
